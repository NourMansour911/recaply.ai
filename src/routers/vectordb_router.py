...
async def vdb_get_chunks(project_id: str,service: VDBService = Depends(get_vdb_service),tenant_id: str = Depends(get_tenant_id)):
...
async def vdb_get_chunks(project_id: str,query: ChunksQuerySchema=Depends(),service: VDBService = Depends(get_vdb_service),tenant_id: str = Depends(get_tenant_id)):
