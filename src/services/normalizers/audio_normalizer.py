...
class AudioNormalizer(BaseNormalizer):
    ...
    def __init__(self, file_path: str, file_name: str, tenant_id: str, project_id: str, language: str, file_type: str):
    ...
    async def _transcribe_audio(self, audio_path: str) -> List[Segment]:
        try:
            ...
            result, _ = whisper_model.transcribe(audio_path, language=self.language)
