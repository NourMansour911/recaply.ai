        ...
        try:
            for seg in segments:
                ...
                try:
                    ...
                    logger.error("Embedding failed for semantic chunking", exc_info=True)
                    raise EmbeddingError(segment_index=segments.index(seg), message=str(e))
            ...
            logger.error("Failed during semantic chunking", exc_info=True)
